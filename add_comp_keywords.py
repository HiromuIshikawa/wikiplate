...
if __name__ == "__main__":
    ...
    for prefix, event, value in parser:
        if (prefix, event) == ('item', 'string'):
            ...
            over_24 = df[df >= 0.24].dropna(how='all', axis=1).to_dict('records')[0]
            ...
            tfidf_24.append({"page_id":a.page_id, "tiidf":over_24})
    ...
    out24 = open("db/json/pro_all_tfidf_compound_over_24_20180601.json","w")
    json.dump(tfidf_24, out24, ensure_ascii=False)
    out24.close()
